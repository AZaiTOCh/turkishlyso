...
Canonical profiles for **resgents** (native agentics). Append role history in each profile; do not invent savings here.
...
| 2 | [Mumblz](MUMBLZ.md) | History chat titles (2 lowercase words) | v0.2 |
| 3 | [Rainman](RAINMAN.md) | Factual cylinder + TOKEX interrogation (0 LLM) | v0.3 |
| 4 | [Agatha](AGATHA.md) | Local archive of Rainman briefs | v0.3 |
...
> Formerly titled Agent Registry / Resgent Registry — canonical name is **Agentic Registry**.
